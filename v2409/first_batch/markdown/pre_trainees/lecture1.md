...
你在学习中的第⼀个任务，就是现在仔细阅读提问的智慧和别像弱智⼀样提问这两篇⽂章，想一想你对"好的提问"以及"通过 STFW 和 RTFM 独⽴解决问题"的看法。
...
你可能会觉得字母 F 冒犯了你，但事实上这个字⺟的含义从来都不是重点，它只是更显示出这三个缩写背后的幽默故事⽽更容易被⼤家记住⽽已。例如，RTFSC 起源于 Linux 之父 Linus Torvalds 在 1991 年 4 ⽉ 1 ⽇回复邮件中的第⼀句话，⽬前在⽹上还能搜到当时的邮件列表。有趣的是，Andrew S. Tanenbaum 在Lessons Learned from 30 Years of MINIX⼀⽂中把这封邮件作为 MINIX 操作系统容易学习的⼀个例⼦：还处于学⽣时代的 Linus Torvalds 在 10 天之内就把 MINIX 学得差不多了。
...
- 资源站：
  - VMware：见群文件
  - Ubuntu 官⽹：[https://ubuntu.com/](https://ubuntu.com/)
...
鉴于你这周依据学习了 GNU/Linux 的使⽤，并且也接触到了 Shell，我们为你提供这个课程： 【课程概览与 shell】[https://missing-semester-cn.github.io/2020/course-shell/](https://missing-semester-cn.github.io/2020/course-shell/)
...
C 语言推荐学习视频：[https://www.bilibili.com/video/BV1XZ4y1S7e1/?vd_source=4ec31615294fd2510d5fd40f0183648f](https://www.bilibili.com/video/BV1XZ4y1S7e1/?vd_source=4ec31615294fd2510d5fd40f0183648f)（翁恺老师⼀⼤特征就是讲课详细，但是带来的代价就是视频长，讲课相当慢；**推荐 1.5-2 倍速且搭配跳转食用**）
