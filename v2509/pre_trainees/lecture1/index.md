...
>
> 你可能会用上的教程：[https:/cn.bing.com/search?q=Linux+Ubuntu+命令教程+-csdn](https://cn.bing.com/search?q=Linux+Ubuntu+命令教程+-csdn)
>
> 你可能需要的科普：[https:/cn.bing.com/search?q=目录和文件的区别+-csdn+-baidu+%2Blinux](https://cn.bing.com/search?q=目录和文件的区别+-csdn+-baidu+%2Blinux)
