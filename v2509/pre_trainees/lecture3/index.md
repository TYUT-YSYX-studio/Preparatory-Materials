...
>
> 它们的练习题也有一定难度，根据上方的学习文档一步步完成[头歌湖南工业大学C语言](https://www.educoder.net/paths/klbm7gto)第7章的和第8章实验中的<strong>一部分</strong>练习。随后完成这个练习：[指针练习](/pre_trainees/lecture3/指针_结构体练习.md)。
>
...
> 
>     a. 即比较过两个字符串的前`n个`字符后仍相等则返回一个`空指针`
> 
> 
