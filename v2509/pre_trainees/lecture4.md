...
其中`argc`和`argv`的使用你需要查看[C语言官方文档（节选pdf）](https://xcnlirxdrdxr.feishu.cn/wiki/NAT3wppJEi4VhTkeG2rceeAXn4g)（或者后方的中文翻译版）获取，只需要阅读`5.1.2.3.2 Program startup`中与`argc`和`argv`有关的部分内容，**并结合STFW**获取答案。同时不要忘记你所学过的指针数组相关知识，这样你才能更好地阅读这个文档。
