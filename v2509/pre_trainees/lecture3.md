...
# 太原理工大学先进计算机系统实验室（ACSL）适应期学员第三次学习路线
...
（**视频后半部分内容涉及到shell脚本语法，****大家暂时****不用深究，学习使用****终端****基本命令即可，以及其中的where命令在大家的Shell上面是没有的，详情可以参考**[**这个文档**](https://geek-blogs.com/blog/linux-where-command/#google_vignette)）
...
接下来指针和结构体的学习，我们给出学习文档供大家参考：[指针/结构体教程](subdocument/指针_结构体教程.md)。

# **练习**

指针和结构体都在C语言中有着举足轻重的作用。前者是内存控制的重要工具，后者是数据结构的基石之一，往后的学习将离不开它们。

它们的练习题也有一定难度，根据上方的学习文档一步步完成[头歌湖南工业大学C语言](https://www.educoder.net/paths/klbm7gto)第7章的和第8章实验中的**一****部分**练习。随后完成这个练习：[指针练习](subdocument/指针_结构体练习.md)。
...
>
> 2. 基础作业 截图提交要求：将你完成**头歌指定题目的截图**重命名为`The`**`coder2`**并放入上述文件夹中
>
