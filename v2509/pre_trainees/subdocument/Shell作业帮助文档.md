...
其实我在这里挖了一个关于BASH\_SOURCE的一个小坑，但并不会真的影响这个作业的完成，就当作是完美吧^\_^
...
这个练习相比missing中的练习要简单些，但能让你学到更多知识并付诸实践，特别是我给出了以上两个教程后。这些原本需要你们**STFW**或**RTFM**掌握的东西直接被我以帮助文档的形式给了出来，也是希望你们在将来学习makefile或cmake时能少些阻碍。
