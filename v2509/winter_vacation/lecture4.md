...
想必有不少同学之前都或多或少做了lcthw的内容，你可能会产生这样的疑惑：“这玩意怎么这么难，这都是怎么想到的，学不会啊”，这是因为lcthw要求你的相关思想和基础都很过关，但是**缺少了数据结构**部分的知识积累，做lcthw中的很多内容都会**极其****痛苦**。

那么接下来的一部分路线就是：**学习数据结构，补足缺下的知识和思想，再去完成lcthw。**

在这一部分学习过程中，我们会学到线性结构中关于**栈，队列，链表，****以及****表达式求值****的****相关****知识，**同时这些知识我们很快就会在lcthw中得到实践。
...
我们目前只需要学习到有关**栈，队列，链表，****以及****表达式求值**的知识，依旧是提交你的**Markdown**笔记。
